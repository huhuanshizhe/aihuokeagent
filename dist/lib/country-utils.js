...
export const COUNTRY_NAME_BY_ISO = Object.fromEntries(COUNTRY_CODES.map(code => [code, regionDisplay.of(code) || code]));
const ZH_COUNTRY_NAMES = {
...
for (const code of COUNTRY_CODES) {
    ...
    if (name)
        aliasMap.set(name.toLowerCase(), code);
}
