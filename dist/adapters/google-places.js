...
export function buildGoogleSearchPlans(query) {
...
function aggregateKeywordStats(stats) {
    const totals = new Map();
    for (const stat of stats)
        totals.set(stat.keyword, (totals.get(stat.keyword) || 0) + stat.fetched);
